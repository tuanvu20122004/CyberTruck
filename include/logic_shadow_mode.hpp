...
public:
   // runMode:
    ...
    //   "policy" : policy controls full-time when state is valid; MPC is still queried for logging/evaluation.
...
private:
    ...
    const int command_period_ms_ = 20;
    ...
    float prev_applied_steering_deg_ = 0.0f;
